...
<div class="container">
  ...
  <div class="navbar-header">
	<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#header-navbar" aria-expanded="false"> <span class="sr-only"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
	  <h1 class="logo hvr-bounce-in"><a href="/News/index/index" title="MZW技术分享博客网站"><img width="60px" height="40px" src="../resources/home/images/logo.png" alt="MZW技术分享博客网站"></a><span>MZW技术分享</span></h1>
  </div>
  <div class="collapse navbar-collapse" id="header-navbar">
	...
	<ul class="nav navbar-nav navbar-right">
	  <li><a data-cont="MZW新闻博客网站" title="MZW新闻博客网站" href="/News/index/index">首页</a></li>
